...
extension UIView {
    ...
    func removeSuperviewConstraints() {
        ...
        superview.constraints.forEach { constraint in
            guard constraint.firstItem as! NSObject == self || constraint.secondItem as! NSObject == self else { return }
    ...
    func removeSizeConstraints() {
        constraints.forEach { constraint in
            guard constraint.firstAttribute == .height || constraint.firstAttribute == .width else { return }
